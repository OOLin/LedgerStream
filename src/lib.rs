...
#[derive(Debug)]
pub struct LedgerStreamProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LedgerStreamProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LedgerStream processing");
    
    let mut processor = LedgerStreamProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LedgerStreamProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LedgerStreamProcessor::new(false);
